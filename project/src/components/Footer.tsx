        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              />
              <span className="text-xl font-bold">Ótica Alfa</span>
            </div>
            <p className="text-gray-300 mb-4">
              Cuidando da sua visão com qualidade, preço justo e atendimento acolhedor.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300">
              <p>📍 Rua Francisco Calado 65</p>
              <p>Vila Nova Cachoeirinha</p>
              <p>📱 (11) 97657-4077</p>
              <p>📞 (11) 2400-6773</p>
              <p>✉️ atendimento@oticaalfa.com</p>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-300 mb-4 md:mb-0">
              © 2024 Ótica Alfa. Todos os direitos reservados.
            </p>
